...
@section('content')
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                <center><h4 class="card-title">@lang('SuperAdmin/backend.add_blog')</h4>
                ...
                <div id="show_form"></div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea value="{{old('description_en')}}" name="description_en" class="form-control" id="textarea_en"
                ...
                <div id="form2" class="forms-sample" >
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail3">{{__('SuperAdmin/backend.blog_description')}}</label>
                        <textarea value="{{old('description_ar')}}" name="description_ar" class="form-control" id="textarea_ar"
