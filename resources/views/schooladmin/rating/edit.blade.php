...
@section('content')
    ...
    <div class="col-12 grid-margin stretch-card">
        ...
        <div class="card">
            <div class="card-body">
                <center><h4 class="card-title">@lang('SuperAdmin/backend.edit_blog')</h4>

                    <change>{{__('SuperAdmin/backend.in_english')}}</change></center>
                    ...
                    <ul class="lang text-right current_page_itemm">
                        <li class="current_page_item selected">
                            <a class="" href="#" onclick="changeLanguage('english', 'arabic')"><img
                                  class="pr-2" src="{{asset('public/frontend/assets/img/eng.png')}}"
                                    alt="logo">{{__('SuperAdmin/backend.english')}}</a>
                        </li>
                        <li>
                ...
                <div id="show_form"></div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea value="{{$blog->description_en}}" name="description_en" class="form-control" id="textarea_en"
                                  placeholder="{{__('SuperAdmin/backend.blog_description')}}"></textarea>
                    </div>
                ...
                <div id="form2" class="forms-sample" >
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail3">{{__('SuperAdmin/backend.blog_description')}}</label>
                        <textarea value="{{$blog->description_ar}}" name="description_ar" class="form-control" id="textarea_ar"
                    ...
                    <button type="button" onclick="submitCommonForBlogForm($(this).parents().find('#formaction').attr('action'))"
                          class="btn btn-primary">@lang('SuperAdmin/backend.submit')
                    </button>
