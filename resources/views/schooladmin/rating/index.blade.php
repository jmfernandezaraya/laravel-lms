    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body table table-responsive">
                <div style="text-align: center;"><h1 class="card-title">@lang('SuperAdmin/backend.rating_details')</h1>
                </div>
                    ...
                    @foreach(\Ghanem\Rating\Models\Rating::with('schools')->with('users')->get() as $rating)
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    @if(!$rating->approved)
                                    <a href="{{route('schooladmin.rating.approve', $rating->id)}}"
                                     class="btn btn-info btn-sm fa fa-check"></a>
                                    @else
