                ...
                <form class="forms-sample" method="POST" action="{{route("superadmin.course.update", $course_id)}}" id="accommodation_under_age_form">
                            ...
                            <div id="accommodation_under_age_clone{{ $loop->iteration - 1 }}" class="accommodation-under-age-clone clone">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 mt-4">
                                        ...
                                        <input class="form-control" type="number" value="{{$accomodation_under_age->under_age_fee_per_week}}" name="under_age_fee_per_week[]" placeholder="{{__('SuperAdmin/backend.under_age_fee_per_week')}}">
                                    </div>
                    ...
                    <script>
                        function fetchAccommodationUnderAge(value) {
                            $.post("{{route('superadmin.course.accomm_under_age.fetch')}}", {
                                _token: "{{csrf_token()}}",
                                value: value
                            }, function(data) {
