                    ...
                    @foreach($course_programs as  $course_program)
                        ...
                        <tr>
                            ...
                            <td><a class="btn btn-primary btn-sm" type="button"
                                   href="{{route("superadmin.course_program_underage_details", $course_program->unique_id)}}">@lang("SuperAdmin/backend.click_here") </a>
                            </td>
                            <td>
                                <div class="btn-group">
                                    &nbsp;
                                    ...
                                    <form method="post" action="{{route('superadmin.course_program_update')}}" id ="submit_form">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select type="text" multiple name="program_age_range"
                                                      class="form-control">
                                                    @foreach(\App\Models\SuperAdmin\Choose_Program_Age_Range::all() as $ages)
                                                        <option
                                                            value="{{$ages->age}}" {{ in_array($ages->age, is_array($course_program->program_age_range) ? $course_program->program_age_range : [] ) ? 'selected' : '' }}>{{$ages->age}}</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="about_couriers_textarea"
                                                        class="form-control">{{$course_program->about_courier}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="inondhu" name=""
                                                        class="form-control">{{$course_program->about_courier_ar}}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="program_start_date"
                                                       value="{{$course_program->program_start_date}}"
                                              class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="x_week_start_date"
                                                       value="{{$course_program->x_week_start_date}}"
                                                     class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                       value="{{$course_program->x_week_end_date}}"
                                                       name="x_week_end_date" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                       value="{{$course_program->how_many_week_free}}"
                                                       name="how_many_week_free" class="form-control">
                                            </div>


                                            <div class="form-group">
                                                <label>@lang('SuperAdmin/backend.summer_fee_per_week')</label>
                                                <input type="number" value="{{$course_program->summer_fee_per_week}}"
                                                       name="summer_fee_per_week" class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label>@lang('SuperAdmin/backend.summer_fee_start_date')</label>
                                                <input type="date" name="summer_fee_start_date"
                                                           value="{{$course_program->summer_fee_start_date}}"
                                                     class="form-control">
                                            </div>

                                            <div class="form-group">
                                                <label>@lang('SuperAdmin/backend.summer_fee_end_date')</label>
                                                <input type="date" name="summer_fee_end_date"
                                                       value="{{$course_program->summer_fee_end_date}}"
                                                     class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number"
                                                       value="{{$course_program->peak_time_fee_per_week}}"
                                                       name="peak_time_fee_per_week" class="form-control">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date"
                                                       value="{{$course_program->peak_time_start_date}}"
                                                       name="peak_time_start_date" class="form-control">
                                            </div>


                                            <div class="form-group">
                                                <label>@lang('SuperAdmin/backend.peak_time_end_date')</label>
                                                <input type="date" value="{{$course_program->peak_time_end_date}}"
                                                       name="peak_time_end_date" class="form-control">
                                            </div>

                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-secondary"
                                                    data-dismiss="modal">@lang('SuperAdmin/backend.close') </button>
