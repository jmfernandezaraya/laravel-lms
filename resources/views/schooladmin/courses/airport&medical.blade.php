        ...
        <div class="card-body">
            ...
            <div class="first-form">
                <form class="forms-sample" method="POST" action="{{route(" superadmin.course.store ")}}" id="courseform">
                    ...
                    <button type="button" onclick="getContent('medical_insurance_note', 'medical_insurance_note_value'); addAirportMedical($(this))" class="btn btn-primary">@lang('SuperAdmin/backend.submit')
                    </button>
                </form>
            </div>
        </div>        
