    ...
    <div class="card">
        <div class="card-body">
            <div style="text-align: center;">
                <h2>@lang('SuperAdmin/backend.accommodation_cost') </h2>
            ...
            <form class="forms-sample" method="POST" action="{{route(" superadmin.course.store ")}}" id="courseform">
                ...
                <div class="first-form">
                    <div id="clone_accommodation_form0">
                        ...
                        <div class="form-group">
                            <label for="age_range">{{__('SuperAdmin/backend.age_range')}} :<i class="fa fa-plus pl-3" data-toggle="modal" data-target="#AccommodationAgeRangeModal" aria-hidden="true"></i><i onclick="DeleteAccomAgeRange()" class="fa fa-trash pl-3" aria-hidden="true"></i></label>
                            <div class="row">
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4" id="remove_custodian0">
                                    ...
                                    <select name="age_range_for_custodian[0][]" id="custodian_age_range_choose0" multiple="multiple" class="3col active">
                                        @foreach(\App\Models\SuperAdmin\Choose_Custodian_Under_Age::orderBy('age', 'asc')->get()->collect()->unique('age')->values()->all() as $option)
                                            <option value="{{$option->age}}">{{$option->age}}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <label>@lang('SuperAdmin/backend.accommodation_start_week'):</label>
                                    <input class="form-control" type="text" name="start_week[]" placeholder="{{__('SuperAdmin/backend.accommodation_duration_start')}}">
                                </div>
                                <div class="col-md-3">
                                    <label>@lang('SuperAdmin/backend.accommodation_end_week'):</label>
                                    <input class="form-control" type="text" name="accomodation_end_week[]" placeholder="{{__('SuperAdmin/backend.accommodation_duration_end')}}">
                                </div>
                                <div class="col-md-3">
                                    <label>@lang('SuperAdmin/backend.accommodation_start_date'):</label>
                                    <input class="form-control" type="date" name="start_date[]" placeholder="{{__('SuperAdmin/backend.accommodation_start_date')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" type="date" name="end_date[]" placeholder="{{__('SuperAdmin/backend.accommodation_end_date')}}">
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input class="form-control" type="date" name="discount_start_date[]" placeholder="{{__('SuperAdmin/backend.discount_start_date')}}">
                                </div>
                                <div class="col-md-3">
                                    <label>{{__('SuperAdmin/backend.discount_end_date')}}:</label>
                                    <input class="form-control" type="date" name="discount_end_date[]" placeholder="{{__('SuperAdmin/backend.discount_end_date')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" type="date" name="summer_fee_start_date[]" placeholder="{{__('SuperAdmin/backend.summer_fee_start_date')}} ">
                                </div>
                                <div class="col-md-4">
                                    <label>@lang('SuperAdmin/backend.summer_fee_end_date'):</label>
                                    <input class="form-control" type="date" name="summer_fee_end_date[]" placeholder="{{__('SuperAdmin/backend.summer_fee_end_date')}} ">
                                </div>
                            </div>
                        </div>
