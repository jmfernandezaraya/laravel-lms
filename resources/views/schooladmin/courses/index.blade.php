                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!($course->accomodations()->get()->isEmpty()))
                                        <a type="button"
                                        href="{{route('schooladmin.accomodation_details', $course->unique_id)}}" class="btn btn-sm btn-primary">@lang('SuperAdmin/backend.click_here')</a>
                                    @else
                                        @lang('SuperAdmin/backend.no_details_available')
                                    @endif
                                </td>
                                <td>
                                    @if(!($course->airports()->get()->isEmpty()))
                                        <a type="button" href="{{route('schooladmin.airport_details', $course->unique_id)}}" class="btn btn-sm btn-primary">@lang('SuperAdmin/backend.click_here')</a>
                                    @else
                                        @lang('SuperAdmin/backend.no_details_available')
                                    @endif
                                </td>
                                <td>
                                    @if(!($course->medicals()->get()->isEmpty()))
                                        <a type="button" href="{{route('schooladmin.medical_details', $course->unique_id)}}" class="btn btn-sm btn-primary">@lang('SuperAdmin/backend.click_here')</a>
                                    @else
                                        @lang('SuperAdmin/backend.no_details_available')
                                    @endif
                                </td>
                            ...
                            <div class="modal fade" id="edit_modal{{$course->unique_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <form method="POST" action="{{route('schooladmin.course_update')}}">
                                            @csrf
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button onclick="getContent('textarea_about_program_ar', 'input_about_courier_ar'); getContent('textarea_about_program', 'input_about_courier)" type="submit" class="btn btn-success">Submit</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
