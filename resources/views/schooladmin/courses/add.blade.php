                ...
                <div class="first-form">
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-3">
                            ...
                            <select onchange="changeSchool()" class="form-control" id="name" name="school_id">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select onchange="changeCountry()" class="form-control" id="country_name" name="">
                                <option>{{__('SuperAdmin/backend.select')}}</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="city_name">{{__('SuperAdmin/backend.choose_city')}}:</label>
                            <select onchange="changeCity()" class="form-control" id="city_name" name="">
                                <option>{{__('SuperAdmin/backend.select')}}</option>
