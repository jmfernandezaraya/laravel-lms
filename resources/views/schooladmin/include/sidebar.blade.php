            ...
            <li class="nav-item nav-profile">
              ...
              <a href="#" class="nav-link">
                ...
                <div class="nav-profile-text d-flex flex-column">
                  ...
                  <span class="font-weight-bold mb-2">{{auth('schooladmin')->user()->{'first_name_'.get_language() } }} {{auth('schooladmin')->user()->{'last_name_'.get_language() } }}</span>
			...
			<li class="nav-item">
              ...
              <div class="collapse" id="manage_app">
                ...
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{route('schooladmin.manage_application.index')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
			...
			<li class="nav-item">
              ...
              <div class="collapse" id="payment_received">
                ...
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="{{route('schooladmin.payment_received.index')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
              ...
              <li class="nav-item {{(request()->is('superadmin/rating/*')) ?  'active' :'' }}">
                  ...
                  <div class="collapse {{(request()->is('superadmin/rating/*')) ?  'show' :'' }}" id="rating">
                      ...
                      <ul class="nav flex-column sub-menu">
                          ...
                          <li class="nav-item"> <a class="nav-link {{(request()->is('superadmin/rating/*')) ?  'active' :'' }}" href="{{route('schooladmin.rating.index')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
              ...
              <li class="nav-item {{(request()->is('superadmin/enquiry/*')) ?  'active' :'' }}">
                  ...
                  <div class="collapse {{(request()->is('superadmin/enquiry/*')) ?  'show' :'' }}" id="enquiry">
                      ...
                      <ul class="nav flex-column sub-menu">
                          ...
                          <li class="nav-item"> <a class="nav-link {{(request()->is('superadmin/enquiry/*')) ?  'active' :'' }}" href="{{url('schooladmin/enquiry')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
              ...
              <li class="nav-item {{(request()->is('schooladmin/send_message_to_student/*')) ?  'active' :'' }}">
                  ...
                  <div class="collapse {{(request()->is('schooladmin/send_message_to_student*')) ?  'show' :'' }}" id="send_message">

                      <ul class="nav flex-column sub-menu">

                          <li class="nav-item"> <a class="nav-link {{(request()->is('schooladmin/send_message_to_student*')) ?  'active' :'' }}" href="{{url('schooladmin/send_message_to_student')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
              ...
              <li class="nav-item {{(request()->is('schooladmin/branch_admin/*')) ?  'active' :'' }}">

                  <a class="nav-link" data-toggle="collapse" href="#branch_admin" aria-expanded="false" aria-controls="branch_admin">
                  ...
                  <div class="collapse {{(request()->is('schooladmin/branch_admin/*')) ?  'show' :'' }}" id="branch_admin">

                      <ul class="nav flex-column sub-menu">

                          <li class="nav-item"> <a class="nav-link {{(request()->is('schooladmin/branch_admin/index')) ?  'active' :'' }}" href="{{route('schooladmin.branch_admin.index')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
              ...
              <li class="nav-item">
                  ...
                  <div class="collapse" id="course">
                      ...
                      <ul class="nav flex-column sub-menu">
                          ...
                          <li class="nav-item"> <a class="nav-link" href="{{route('schooladmin.course.index')}}">{{ __('SuperAdmin/dashboard.view')}} </a></li>
