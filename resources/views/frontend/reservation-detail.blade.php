        ...
        <div class="inter-full mt-3">
            <div class="course-details border-bottom">
                ...
                <form id="course_form_paid" enctype="multipart/form-data" action="{{route('payment-gateway')}}" method="POST">
                    <h6 class="best">{{__('Frontend.total_cost')}}</h6>
                    <p>Please Note: Balance / final payment will be according to the exchange rate for the day of the payment
                    </p>

                    <?php
                        $array = (array)$request;
                        $array['total_fees'] = $request->total_fees . " " . $currency['cost'];
                        $array['other_currency'] = $total_fees['converted_value'] . " " . $currency['converted'];
                    ...
                    <div class="study m-2">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-5 col-form-label">{{__('Frontend.first_name')}}*</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="fname" required name="fname" placeholder="{{__('Frontend.first_name')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="mname" class="col-sm-5 col-form-label">{{__('Frontend.middle_name')}}</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-5 col-form-label">{{__('Frontend.last_name')}}*</label>
                                    <div class="col-sm-7">
                                        <input onchange="getName($('#fname').val(), $('#mname').val(), $(this).val())" type="text" required class="form-control" id="lname" name="lname" placeholder="{{__('Frontend.last_name')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-5 col-form-label">{{__('Frontend.date_of_birth')}}:</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="city" class="col-sm-5 col-form-label">{{__('Frontend.place_of_birth')}}</label>
                                    <div class="col-sm-7">
                                        <input type="text" required class="form-control" name="city" id="city" placeholder="{{__('Frontend.city')}}*">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <div class="col-sm-7">
                                        <input type="text" required name="country" class="form-control" id="country" placeholder="{{__('Frontend.country')}}*">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="city" class="col-sm-5 col-form-label">{{__('Frontend.gender')}}</label>
                                    <div class="col-sm-7">
                                        <div class="form-check form-check-inline">
                                            <input required class="form-check-input" type="radio" name="gender" value="male" checked>
                                            <label class="form-check-label">{{__('Frontend.male')}}</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="gender" value="female">
                                            <label class="form-check-label">{{__('Frontend.female')}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="nat" class="col-sm-5 col-form-label">{{__('Frontend.nationality')}}</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="Passport" class="col-sm-5 col-form-label">{{__('Frontend.passport_no')}}</label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="portdate" class="col-sm-5 col-form-label">{{__('Frontend.passport_date_of_issue')}}</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="edate" class="col-sm-5 col-form-label">{{__('Frontend.passport_date_of_expiry')}}</label>
                                    <div class="col-sm-7">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="fname" class="col-sm-5 col-form-label">{{__('Frontend.upload_passport_details')}}</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    <label for="city" class="col-sm-5 col-form-label">{{__('Frontend.study_finance')}}</label>
                                    <div class="col-sm-7">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" name="study_finance" onclick="getBankStatement($(this).val()); displayFinancial($(this).val())" type="radio" id="inlineCheckbox1" value="personal" checked>
                                            <label class="form-check-label">{{__('Frontend.personal')}}</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label">{{__('Frontend.scholarship')}}</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6" id="financial_guarantee">
                                <div class="form-group row">
                                    <label for="nat" class="col-sm-5 col-form-label">{{__('Frontend.upload_financial_gurantee')}}</label>
                                    <div class="col-sm-7">
                        ...
                        <div class="row">
                            ...
                            <div class="w-100">
                                @if($program->program_registration_fee != null)
                                    <h6 class="best">{{__('Frontend.deposit_registraion_fee')}}: {{ $deposit_price['value'] }} {{$currency['cost']}} / {{ $program_registration_fee['value'] }} {{$currency['converted']}}</h6>
                                @else
                                    <h6 class="best">{{__('Frontend.deposit_registraion_fee')}}: {{ $program_registration_fee['value'] }} {{$currency['converted']}}</h6> @endif @if(isset($request->courier_fee))
                                    <h6 class="best">{{__('Frontend.courier_fee')}}: {{readCalculationFromDB('courier_fee')}} {{$currency['cost']}} / {{$courier_price}} {{$currency['converted']}} </h6>
                                    <input hidden value="{{$courier_fee['value']}}" name="courier_fee">
                                @endif

                                <h6 class="best">{{__('Frontend.total')}} {{$request->total_fees}} {{$currency['cost']}} / {{$total_fees['converted_value']}}{{$currency['converted']}}</h6>
                            </div>

                            <input hidden id="fees_to_be_paid" value="{{$deposit_price['value']}}" name="paid_amount">
