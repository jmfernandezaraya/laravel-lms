...
@section('content')
    ...
    <div class="inter-full mt-3">
        ...
        <form method="POST" action="{{route('frontend.course.details.save')}}">
                ...
                <table class="table table-bordered table-no-drawable" id="program_fees_table">
                    <thead>
                        <tr>
                            ...
                            <th>{{__('Frontend.amount')}} / <span class="cost_value_currency"></span></th>
                            <th>{{__('Frontend.amount')}} / <span class="converted_value_currency"></span></th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr id="program_cost">
                        ...
                        <tr id="text_book_fee">
                            <td>{{__('Frontend.text_book_fee')}}
                                <i class="fa fa-question-circle pl-2 text_book_fee_note" data-toggle="modal" data-target="#TextBookFeeModal" aria-hidden="true" style="display: none"></i>
                            </td>
                            <td class="cost_value">0</td>
                            <td class="converted_value">0</td>
                        </tr>
            ...
            <!-- Text Book Fee Modal -->
            <div class="modal fade" id="TextBookFeeModal" tabindex="-1" role="dialog" aria-labelledby="TextBookFeeModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="TextBookFeeModalLabel">{{__('Frontend.text_book_fee_note')}}</h5>
