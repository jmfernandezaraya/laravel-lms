                            ...
                            <div class="col-md-12">
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label">
                                        {{__('Frontend.i_read_and_agreed_to_the')}} (<a href="{{ isset($reservation_links['registration_conditions']) ? $reservation_links['registration_conditions'] : $school->website_link }}">{{__('Frontend.registration_conditions')}}</a>, <a href="{{ isset($reservation_links['terms_and_conditions']) ? $reservation_links['terms_and_conditions'] : $school->website_link }}">{{__('Frontend.terms_and_conditions')}}</a> & <a href="{{ isset($reservation_links['private_policy']) ? $reservation_links['private_policy'] : $school->website_link }}">{{__('Frontend.private_policy')}}</a>) {{str_replace("###SITE_NAME", __('Frontend.of_site_name'), __('Frontend.site_name'))}}
                                    </label>
                                </div>
                            </div>
                        </div>
