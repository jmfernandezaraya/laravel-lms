...
@section('content')
    ...
    <div class="page-content">
        <div class="card">
            <div class="card-body">
                <form id="formaction" class="forms-sample" method="post" action="{{route('superadmin.payment_method.update', $payment_method->id)}}">
                    {{csrf_field()}}
                    @method('PUT')
                    ...
                    <div id="form1">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <div class="english">
                                    <input value="{{$payment_method->name}}" name="name" type="text" class="form-control" placeholder="{{__('Admin/backend.payment_method')}}">
                                </div>
                                <div class="arabic">
                                    <input value="{{$payment_method->name_ar}}" name="name_ar" type="text" class="form-control" placeholder="{{__('Admin/backend.payment_method')}}">
                                </div>
                            </div>
                        </div>
                    </div>
