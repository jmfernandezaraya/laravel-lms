        ...
        <h3 class="page-title">
             ...
             <div class="row">
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                  <div class="card-body">
                    ...
                    <h4 class="font-weight-normal mb-3">Total Schools <i class="mdi mdi-chart-line mdi-24px float-right"></i>
                    </h4>
					@php $school = $school_count ;
					$school_admin= $super_admin_count;
              ...
              <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                  <div class="card-body">
                    <img src="{{asset('assets/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Total School Admin <i class="mdi mdi-bookmark-outline mdi-24px float-right"></i>
                    </h4>
			 ...
			 <!-- <div class="row">
              ...
              <div class="col-md-5 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 class="card-title">Traffic Sources</h1>
            ...
            <div class="row">
              <div class="col-12 grid-margin">
                <div class="card">
                  <div class="card-body">
                    <h1 class="card-title">Recent Tickets</h1>
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="{{asset('assets/images/user.png')}}" class="mr-2" alt="image"> David Grey
                            </td>
			 ...
			 <div class="row">
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h1 class="card-title">Recent Updates</h1>
                    <div class="d-flex">
