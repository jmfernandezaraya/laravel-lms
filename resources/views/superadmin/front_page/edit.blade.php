...
@section('title')
    {{__('Admin/backend.edit_front_page')}}
@endsection
        ...
        <div class="card">
            <div class="card-body">
                <div style="text-align: center;">
                    <h1 class="card-title">{{__('Admin/backend.edit_front_page')}}</h1>
                    <change>
                        <div class="english">
                ...
                <form id="frontPageForm" class="forms-sample" method="post" action="{{route('superadmin.setting.front_page.update', $front_page->id)}}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="english">
                                <input onchange="changeFrontPageTitle()" value="{{$front_page->title}}" name="title" type="text" class="form-control" placeholder="{{__('Admin/backend.title')}}">
                            </div>
                            <div class="arabic">
                                <input value="{{$front_page->title_ar}}" name="title_ar" type="text" class="form-control" placeholder="{{__('Admin/backend.title')}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="slug">{{__('Admin/backend.slug')}}</label>
                            <input value="{{$front_page->slug}}" name="slug" type="text" class="form-control" placeholder="{{__('Admin/backend.slug')}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="english">
                                <textarea id="content" name="content" class="form-control ckeditor-input" placeholder="{{__('Admin/backend.content')}}">{!! $front_page->content !!}</textarea>
                            </div>
                            <div class="arabic">
                                <textarea id="content_ar" name="content_ar" class="form-control ckeditor-input" placeholder="{{__('Admin/backend.content')}}">{!! $front_page->content_ar !!}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
