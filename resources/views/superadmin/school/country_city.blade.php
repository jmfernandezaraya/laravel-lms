...
@section('title')
    {{__('SuperAdmin/backend.school_coutries_cities')}}
@endsection
...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                <div style="text-align: center;">
                    <h1 class="card-title">{{__('SuperAdmin/backend.school_coutries_cities')}}</h1>
                    <change>
                        <div class="english">
    ...
    <div class="page-content">
        <div class="card">
            <div class="card-body">
                <form id="countryCityForm" class="forms-sample" enctype="multipart/form-data" action="{{route('superadmin.school.country_city.update')}}" method="post">
                    {{csrf_field()}}
                    ...
                    @forelse ($countries as $country)
                        <div id="country_clone{{$loop->iteration - 1}}" class="country-clone clone">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>{{__('SuperAdmin/backend.country')}}</h3>
                                    <div class="english">
                                        <input value="{{$country->name}}" class="form-control" type="text" name="name[]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                    </div>
                                    <div class="arabic">
                                        <input value="{{$country->name_ar}}" class="form-control" type="text" name="name_ar[]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                    </div> 
                                </div>
                                <div class="col-md-6">
                                    <h3>{{__('SuperAdmin/backend.city')}}</h3>
                                    ...
                                    @forelse ($country->cities as $city)
                                        <div id="city{{$loop->parent->iteration - 1}}_clone{{$loop->iteration - 1}}" class="city-clone clone form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="english">
                                                        <input value="{{$city->name}}" class="form-control" type="text" name="city_name[{{$loop->parent->iteration - 1}}][]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                                    </div>
                                                    <div class="arabic">
                                                        <input value="{{$city->name_ar}}" class="form-control" type="text" name="city_name_ar[{{$loop->parent->iteration - 1}}][]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                    ...
                                    @empty
                                        <div id="city{{$loop->iteration - 1}}_clone0" class="city-clone clone form-group">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    <div class="english">
                                                        <input value="" class="form-control" type="text" name="city_name[{{$loop->iteration - 1}}][]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                                    </div>
                                                    <div class="arabic">
                                                        <input value="" class="form-control" type="text" name="city_name_ar[{{$loop->iteration - 1}}][]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <i class="fa fa-plus-circle" aria-hidden="true" onclick="addSchoolCityForm($(this))"></i>
                        ...
                        <div id="country_clone0" class="country-clone clone">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>{{__('SuperAdmin/backend.country')}}</h3>
                                    <div class="english">
                                        <input value="" class="form-control" type="text" name="name[]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                    </div>
                                    <div class="arabic">
                                        <input value="" class="form-control" type="text" name="name_ar[]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                    </div> 
                                </div>
                                <div class="col-md-6">
                                    <h3>{{__('SuperAdmin/backend.city')}}</h3>
                                    ...
                                    <div id="city0_clone0" class="city-clone clone form-group">
                                        <div class="row">
                                            <div class="col-md-9">
                                                <div class="english">
                                                    <input value="" class="form-control" type="text" name="city_name[0][]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                                </div>
                                                <div class="arabic">
                                                    <input value="" class="form-control" type="text" name="city_name_ar[0][]" placeholder="{{__('SuperAdmin/backend.name')}}">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <i class="fa fa-plus-circle" aria-hidden="true" onclick="addSchoolCityForm($(this))"></i>
                    ...
                    <button type="button" onclick="submitForm($(this).parents().find('#countryCityForm'))" class="btn btn-gradient-primary mr-2">{{__('SuperAdmin/backend.submit')}}</button>
