        ...
        <div class="card">
            <div class="card-body table table-responsive">
                <div style="text-align: center;">
                    <h1 class="card-title">@lang('Admin/backend.visa_application.application_details')</h1>
                </div>
                    ...
                    <tbody>
                        @foreach($visas as $visa)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('superadmin.visa.otherfields', $visa->id)}}" class="btn btn-primary btn-sm">@lang('Admin/backend.click_here') </a></td>
