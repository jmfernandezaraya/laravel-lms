...
<div class="container mt-5 mb-5">
    <form id="visa-form" method="post" enctype="multipart/form-data" action="{{route('superadmin.visa_submit')}}">
        @csrf
        ...
        <div class="left">
            <div class="form-row">
                ...
                <div class="form-group col-md-6">
                    <label for="inputappliccation">Choose visa appliccation center
                        ...
                        <i class="fa fa-trash pl-3" data-url="{{route('superadmin.delete_application_center')}}" onclick="deleteApplicationCenter($(this))" aria-hidden="true"></i>
                    </label>
                    <br>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputvisa1">What is your Nationality
                        ...
                        <i class="fa fa-trash pl-3" onclick="deleteNationality($(this))" data-url="{{route('superadmin.delete_nationality')}}" aria-hidden="true"></i>
                    </label>
            ...
            <input hidden name="visa_information_en" id="input_en" val="">
            <input hidden name="visa_information_ar" id="input_ar" val="">

            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="inputEmail4">Visa Fee</label>
                    <input type="number" name="visa_fee" class="form-control" id="inputvisa5" placeholder="1000">
                </div>
                <div class="form-group col-md-6">
                    <label for="inputPassword4">Insurance Fee</label>
                    <input type="number" name="insurance_fee" class="form-control" id="inputvisa6" placeholder="1500">
                </div>
            </div>
            <div class="clone_visa0">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Other visa fee</label>
                        <input type="text" name="other_visa_name[]" class="form-control" id="inputvisa7" placeholder="other visa fee">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Other visa price</label>
                        <input type="number" name="other_visa_price[]" class="form-control" id="inputvisa8" placeholder="200">
                    </div>
                </div>
            </div>
            <div class="form-row">
            ...
            <div class="clone_visa_service0">
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Visa Services fee</label>
                        <input type="number" name="visa_service_fee[]" class="form-control" id="inputVisa9" placeholder="200">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputPassword4">Tax Fee</label>
                        <input type="number" name="tax_fee[]" class="form-control" id="inputVisa11" placeholder="15">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" name="travelers_number_start[]" class="form-control" id="inputVisa12" placeholder="Travelers Number Start">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="inputEmail4">Travelers Number End</label>
                        <input type="number" name="travelers_number_end[]" class="form-control" id="inputVisa13" placeholder="Travelers Number End">
                    </div>
                </div>
            </div>
            <div class="form-row">
