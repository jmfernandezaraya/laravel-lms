...
@section('title')
    {{__('SuperAdmin/backend.add_course')}}
@endsection
                    ...
                    <div class="first-form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-3">
                                ...
                                <div class="arabic">
                                    <input class="form-control" type="text" name="program_name_ar" placeholder="{{__('SuperAdmin/backend.program_name')}}">
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="program_level_required">{{__('SuperAdmin/backend.level_required')}}:</label>
                                <div class="english">
                                    <input class="form-control" type="text" name="program_level" placeholder="{{__('SuperAdmin/backend.level_required')}}">
                                </div>
                                <div class="arabic">
                                    <input class="form-control" type="text" name="program_level_ar" placeholder="{{__('SuperAdmin/backend.level_required')}}">                                    
                                </div>
                            </div>
                            <div class="form-group col-md-3">
                                <label for="lessons_per_week">{{__('SuperAdmin/backend.lessons_per_week')}}:</label>
                                <input class="form-control" type="number" name="lessons_per_week" placeholder="{{__('SuperAdmin/backend.lessons_per_week')}}">
                            </div>
                            <div class="form-group col-md-3">
                                <label for="hours_per_week">{{__('SuperAdmin/backend.hours_per_week')}}:</label>
                                <input class="form-control" type="number" name="hours_per_week" placeholder="{{__('SuperAdmin/backend.hours_per_week')}}">
                            </div>
                        </div>
