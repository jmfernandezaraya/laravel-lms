        ...
        <div class="card">
            <div class="card-body table table-responsive">
                <div style="text-align: center;">
                    <h1 class="card-title">{{__('SuperAdmin/backend.airport_details')}}</h1>
                </div>
                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th> {{__('SuperAdmin/backend.airport_name')}} </th>
                            <th> {{__('SuperAdmin/backend.airport_service_name')}} </th>
                            <th> {{__('SuperAdmin/backend.airport_service_fee')}} </th>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel5">{{__('SuperAdmin/backend.update_airport_fees')}}</h5>
                                        ...
                                        <form method="post"  action="{{route('superadmin.airport_update')}}">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>{{__('SuperAdmin/backend.airport_name')}} {{__('SuperAdmin/backend.in_english')}}</label>
                                                    <input hidden name="id" value="{{$airport->unique_id}}">
                                                    <input type="text" value="{{$airport->name_en}}" name="name_en" class="form-control">
                                                </div>

                                                <div class="form-group">
                                                    <label>{{__('SuperAdmin/backend.airport_name')}} {{__('SuperAdmin/backend.in_arabic')}}</label>
                                                    <input type="text" value="{{$airport->name_ar}}" name="name_ar" class="form-control">
                                                </div>
                                                <div class="form-group">
                                                    <label>{{__('SuperAdmin/backend.airport_service_name')}} {{__('SuperAdmin/backend.in_english')}}</label>
                                                    <input type="text" value="{{$airport->service_name_en}}" name="service_name_en" class="form-control">
                                                </div>

                                                <div class="form-group">
                                                    <label>{{__('SuperAdmin/backend.airport_service_name')}} {{__('SuperAdmin/backend.in_arabic')}}</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="submit" class="btn btn-primary">{{__('SuperAdmin/backend.update_changes')}}</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
