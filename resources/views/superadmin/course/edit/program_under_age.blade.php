                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control" name="text_book_fee_type[]">
                                        <option {{$program_text_book_fee->text_book_fee_type == 'fixed_cost' ? 'selected' : ''}} value="fixed_cost">{{__('SuperAdmin/backend.fixed_cost')}}</option>
                                        <option {{$program_text_book_fee->text_book_fee_type == 'per_week' ? 'selected' : ''}} value="cost_per_week">{{__('SuperAdmin/backend.per_week')}}</option>
                                    </select>
                                </div>
                            </div>
