...
<a href = "{{route('superadmin.blogs.create')}}" type="button" class="btn btn-primary btn-sm pull-right"><i class="fa fa-plus"></i>&nbsp;{{__('SuperAdmin/backend.add')}}</a>
...
<td class="show-read-more"><p>{!! ucwords($blog->{'description_'. get_language()} )  !!}</p></td>
<td>
  {{$blog->created_at}}
</td>
