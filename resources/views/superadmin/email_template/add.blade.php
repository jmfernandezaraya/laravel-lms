                ...
                <form id="emailTemplateForm" class="forms-sample" method="post" action="{{route('superadmin.email_template.store')}}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="english">
                                <input name="admin_subject" type="text" class="form-control" placeholder="{{__('Admin/backend.admin_subject')}}">
                            </div>
                            <div class="arabic">
                                <input name="admin_subject_ar" type="text" class="form-control" placeholder="{{__('Admin/backend.admin_subject')}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <div class="english">
                                <input value="{{ env('MAIL_FROM_NAME') }}" name="admin_sender_name" type="text" class="form-control" placeholder="{{__('Admin/backend.admin_sender_name')}}">
                            </div>
                            <div class="arabic">
                                <input value="{{ env('MAIL_FROM_NAME') }}" name="admin_sender_name_ar" type="text" class="form-control" placeholder="{{__('Admin/backend.admin_sender_name')}}">
                            </div>
                        </div>
                        <div class="form-group col-md-6">
                            <label for="admin_sender_email">{{__('Admin/backend.sender_email')}}</label>
                            <input value="{{ env('MAIL_FROM_ADDRESS') }}" name="admin_sender_email" type="email" class="form-control" placeholder="{{__('Admin/backend.admin_sender_email')}}">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="english">
                                <textarea id="admin_content" name="admin_content" class="form-control ckeditor-input" placeholder="{{__('Admin/backend.admin_content')}}"></textarea>
                            </div>
                            <div class="arabic">
                                <textarea id="admin_content_ar" name="admin_content_ar" class="form-control ckeditor-input" placeholder="{{__('Admin/backend.admin_content')}}"></textarea>
                            </div>
                        </div>
                    </div>
