                ...
                <form id ="blogForm" class="forms-sample" method="post" action="{{route('superadmin.blog.store')}}" onsubmit="getCkEditorsData()">
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="english">
                                <input value="{{old('title_en')}}" name="title_en" type="text" class="form-control" placeholder="{{__('Admin/backend.blog_title')}}">
                            </div>
                            <div class="arabic">
                                <input value="{{old('title_ar')}}" name="title_ar" type="text" class="form-control" placeholder="{{__('Admin/backend.blog_title')}}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <div class="english">
                                <textarea id="description_en" name="description_en" class="form-control ckeditor-input" placeholder="{{__('Admin/backend.blog_description')}}">{!! old('description_en') !!}</textarea>
                            </div>
                            <div class="arabic">
                                <textarea id="description_ar" name="description_ar" class="form-control ckeditor-input" placeholder="{{__('Admin/backend.blog_description')}}">{!! old('description_ar') !!}</textarea>
                            </div>
                        </div>
                    </div>
