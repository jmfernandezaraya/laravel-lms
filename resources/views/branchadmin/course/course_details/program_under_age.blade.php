    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body table table-responsive">
                <div style="text-align: center;"><h1 class="card-title">@lang('Admin/backend.course_program_details')</h1></div>
                    ...
                    <tbody>
                        @foreach($programs as  $program)
                            <tr>
                                ...
                                <td>{{$program->under_age_fee_per_week}}</td>
                                        ...
                                        <form method="POST" action="{{route('admin.course_program_edit')}}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="under_age_fee_per_week" value="{{$program->under_age_fee_per_week}}">
                                                </div>
                                            </div>
