    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body table table-responsive">
                <div style="text-align: center;"><h1 class="card-title">@lang('Admin/backend.accommodation_details')</h1></div>

                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th> @lang('Admin/backend.accommodation_type') </th>
                            <th> @lang('Admin/backend.room_type') </th>
                            <th> @lang('Admin/backend.meal_type') </th>
                            <th> @lang('Admin/backend.age_range') </th>
                            <th> @lang('Admin/backend.accommodation_placement_fee') </th>
                            <th> @lang('Admin/backend.program_duration') </th>

                            <th> @lang('Admin/backend.accommodation_deposit_fee') </th>

                            <th> @lang('Admin/backend.special_diet_fee') </th>
                            <th> @lang('Admin/backend.special_diet_note') </th>

                            <th> @lang('Admin/backend.accommodation_fee') </th>
                            <th> @lang('Admin/backend.accommodation_start_week') </th>
                            <th> @lang('Admin/backend.accommodation_end_week') </th>
                            <th> @lang('Admin/backend.accommodation_start_date') </th>
                            <th> @lang('Admin/backend.accommodation_end_date') </th>
                            ...
                            <th> @lang('Admin/backend.christmas_fee_per_week') </th>
                            <th> @lang('Admin/backend.christmas_start_date')</th>

                            <th> @lang('Admin/backend.christmas_end_date') </th>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(!($accomodation->AccommodationUnderAges()->get()->isEmpty()))
                                        <a type="button" href="{{route('superadmin.accomodation_underage_details', $accomodation->unique_id)}}" class="btn btn-sm btn-primary">@lang('Admin/backend.click_here')</a>
                                    @else
                                    ...
                                    <div class="modal-content">
                                        <form method="POST" action="{{route('superadmin.accommodation_update')}}">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">@lang('Admin/backend.update_accommodation_price')</h5>
