        ...
        <div class="card">
            <div class="card-body table table-responsive">
                <div style="text-align: center;"><h1
                      class="card-title">@lang('Admin/backend.course_program_details')</h1>
                </div>
                ...
                <table class="table table-hover table-bordered">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th> @lang('Admin/backend.program_registration_free') </th>
                            <th> @lang('Admin/backend.program_duration') </th>
                            <th> @lang('Admin/backend.age_range') </th>
                            <th> @lang('Admin/backend.courier_fee') </th>
                            <th> @lang('Admin/backend.about_courier') </th>
                            <th> @lang('Admin/backend.program_cost') </th>

                            <th> @lang('Admin/backend.program_duration_start') </th>
                            <th> @lang('Admin/backend.program_duration_end') </th>
                            <th> @lang('Admin/backend.program_start_date') </th>
                            <th> @lang('Admin/backend.program_end_date') </th>
                            <th> @lang('Admin/backend.discount_per_week') </th>
                            <th> @lang('Admin/backend.discount_start_date') </th>

                            <th> @lang('Admin/backend.discount_end_date') </th>

                            <th> @lang("Admin/backend.x_week_selected") </th>
                            <th> @lang('Admin/backend.week_start_date')</th>
                            <th> @lang('Admin/backend.week_end_date')</th>
                            <th> @lang('Admin/backend.week_free')</th>
                            <th> @lang('Admin/backend.summer_fee_per_week')</th>
                            <th> @lang('Admin/backend.summer_fee_start_date')</th>
                            <th> @lang('Admin/backend.summer_fee_end_date')</th>

                            <th> @lang('Admin/backend.peak_time_fee_per_week')</th>
                            <th> @lang("Admin/backend.peak_time_start_date") </th>
                            <th> @lang("Admin/backend.peak_time_end_date") </th>
                            <th> @lang('Admin/backend.program_under_age_fee') </th>
                    ...
                    <tbody>
                        @foreach($course_programs as  $course_program)
                            <tr>
                                ...
                                <td>
                                    <a class="btn btn-primary btn-sm" type="button" href="{{route("admin.course_program_underage_details", $course_program->unique_id)}}">@lang("Admin/backend.click_here") </a>
                                </td>
                                <td>
                                    <div class="btn-group">
                                        &nbsp;
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title"
                                                id="exampleModalLabel5">@lang('Admin/backend.course_program_update')</h5>
                                        ...
                                        <form method="post" action="{{route('superadmin.course_program_update')}}" id ="submit_form">
                                            ...
                                            <div class="modal-body">
                                                <div class="form-group">
                                                    <label>@lang('Admin/backend.program_registration_free')</label>
                                                ...
                                                <div class="form-group">
                                                    <label>@lang('Admin/backend.courier_fee')</label>
                                                    <input type="number" name="courier_fee"
                                                        value="{{$course_program->courier_fee}}" class="form-control">
                                                </div>

                                                <div class="form-group">
                                                    <label>@lang('Admin/backend.about_courier') @lang('Admin/backend.in_english')</label>
                                                    <textarea id="about_couriers_textarea" class="form-control">{{$course_program->about_courier}}</textarea>
                                                </div>

                                                <div class="form-group">
                                                    <label>@lang('Admin/backend.about_courier') @lang('Admin/backend.in_arabic')</label>
                                                ...
                                                <div class="form-group">
                                                    <label>@lang('Admin/backend.how_many_week_free')</label>
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button id="magic" onclick="getContent('inondhu', 'nandhu'); submit_courseprogram($(this))" type="button"
                                                    class="btn btn-primary">@lang('Admin/backend.update_changes')</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
