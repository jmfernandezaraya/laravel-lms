                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="language[]" multiple="multiple" class="form-control">
                                                        @foreach(\App\Models\ChooseLanguage::all() as $language)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="study_mode[]" multiple="multiple" class="form-control">
                                                        @foreach(\App\Models\ChooseStudyMode::all() as $study_mode)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="school_id" class="form-control">
                                                        @foreach(\App\Models\School::all() as $schools)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="study_time[]" multiple="multiple" class="form-control">
                                                        @foreach(\App\Models\ChooseStudyTime::all() as $study_time)
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="every_day[]" multiple="multiple" class="form-control">
                                                        @foreach(\App\Models\ChooseStartDate::all() as $start_day)
