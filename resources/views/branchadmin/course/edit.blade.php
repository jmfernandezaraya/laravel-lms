        ...
        <div class="card-body">
            ...
            <form id="form1" class="forms-sample" enctype="multipart/form-data" action="{{route('school.store')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input value="{{$school_en->email}}" name="email" type="text" class="form-control" id="email" placeholder="{{__('Admin/backend.email_address')}}">
                </div>
                @if($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    <input value="{{$school_en->contact}}" name="contact" class="form-control" id="contact" placeholder="{{__('Admin/backend.contact_number')}}" type="text">
                ...
                <div class="form-group">
                    ...
                    <textarea name="about" class="form-control" id="about" rows="4">{{$school_en->about}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input name="city" type="text" class="form-control" id="city" placeholder="{{__('Admin/backend.enter_city')}}" value="{{$school_en->city}}">
                </div>
                @if($errors->has('city'))
                ...
                <div class="form-group">
                    ...
                    <input name="country" type="text" class="form-control" id="country" placeholder="{{__('Admin/backend.enter_country')}}" value="{{$school_en->country}}">
                </div>
            ...
            <form id="form2" class="forms-sample" enctype="multipart/form-data" method="post">
                ...
                <div class="form-group">
                    <label for="about">{{__('Admin/backend.about_the_school')}}</label>
                    <textarea name="about" class="form-control" id="about" rows="4">{{$school_ar->about}}</textarea>
                </div>
                @if($errors->has('about'))
                    <div class="alert alert-danger">{{$errors->first('about')}}</div>
                @endif
				...
				<div class="form-group">
                    <label for="city">{{__('Admin/backend.enter_city')}}</label>
                    <input name="city" type="text" class="form-control" id="city" placeholder="{{__('Admin/backend.enter_city')}}" value="{{$school_ar->city}}">
                </div>
                @if($errors->has('city'))
                    <div class="alert alert-danger">{{$errors->first('city')}}</div>
                @endif
                ...
                <div class="form-group">
                    <label for="country">{{__('Admin/backend.enter_country')}}</label>
                    <input name="country" type="text" class="form-control" id="country" placeholder="{{__('Admin/backend.enter_country')}}" value="{{$school_ar->country}}">
                </div>
                @if($errors->has('country'))
                    <div class="alert alert-danger">{{$errors->first('address')}}</div>
                @endif
