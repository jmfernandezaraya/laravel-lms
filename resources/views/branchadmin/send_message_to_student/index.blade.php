                    ...
                    <tbody>
                        @foreach($allcustomers as $customer)
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="{{route('visa.edit', $customer->id)}}" data-toggle="modal" data-target="#SendMessageModal{{$customer->id}}" class="btn btn-info btn-sm fa fa-telegram"></a>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <div class="modal fade" id="SendMessageModal{{$customer->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <form method="post" action="{{route('branch_admin.send_message.sendmessage')}}" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="exampleInputname">@lang('SchoolAdmin.send_attachment')</label>
                                                    <input type="file" name="file" class="form-control" id="study_english" aria-describedby="emailHelp">
                                                    <br>
                                                </div>
                                            </div>
