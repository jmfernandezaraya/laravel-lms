        ...
        <div class="card-body">
            ...
            <form id="form1" class="forms-sample" enctype="multipart/form-data" action="{{route('superadmin.schools.store')}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input name="school_capacity" type="text" class="form-control" id="exampleInputName1"
                            placeholder="{{__('SuperAdmin/backend.school_capacity')}}"
            ...
            <form id="form2" class="forms-sample" enctype="multipart/form-data" method="post" action = "{{route('branch_admin.schools.store')}}">
                {{csrf_field()}}
                <div class="form-group">
                    <label for="exampleInputName1">{{__('SuperAdmin/backend.school_name')}}</label>
                ...
                <div class="form-group">
                    <label for="exampleInputEmail3">{{__('SuperAdmin/backend.school_email_address')}}</label>
                    <input value="{{$school_ar->email}}" name="email" type="text" class="form-control" id="exampleInputEmail3" placeholder="{{__('SuperAdmin/backend.school_email_address')}}">
                </div>
                ...
                <div class="form-group">
                    <label for="exampleInputName1">{{__('SuperAdmin/backend.school_emergency_number')}}</label>
                    <input name="emergency_number" type="text" class="form-control" id="exampleInputName1" placeholder="{{__('SuperAdmin/backend.school_emergency_number')}}" value="{{$school_ar->emergency_number}}">
                </div>
