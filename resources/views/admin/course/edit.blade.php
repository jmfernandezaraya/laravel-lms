                ...
                <form class="forms-sample" method="POST" action="{{ auth('superadmin')->check() ? route('superadmin.course.update', $course->unique_id) : route('schooladmin.course.update', $course->unique_id) }}" id="form1">
                    ...
                    <div class="first-form">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="program_language">{{__('Admin/backend.choose_study_mode')}}:
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <label for="classes_days">{{__('Admin/backend.classes_days')}}:
                            ...
                            <div id="course_program_clone{{$loop->iteration - 1}}" class="course-program-clone clone">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" value="{{ $course_program->program_registration_fee }}" type="number" name="program_registration_fee[]" placeholder="{{__('Admin/backend.program_registration_free')}}">
                                    </div>
                                    <div class="form-group col-md-4">
