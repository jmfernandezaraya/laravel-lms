                        ...
                        <div id="under_age_fee_clone{{ $loop->iteration - 1 }}" class="under-age-fee-clone clone">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 mt-4">
                                    ...
                                    <input value="{{$program_under_age_fee->under_age_fee_per_week}}" class="form-control" type="number" name="under_age_fee_per_week[]" placeholder="{{__('Admin/backend.fees_week')}}">
                                </div>
                        ...
                        <div id="text_book_fee_clone{{ $loop->iteration - 1 }}" class="text-book-fee-clone clone">
                            ...
                            <div class="row">
                                <div class="form-group col-md-3">
                                    ...
                                    <input value="{{$program_text_book_fee->text_book_fee}}" class="form-control" type="number" name="text_book_fee[]" placeholder="{{__('Admin/backend.fee')}}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label>{{__('Admin/backend.start_date')}}:</label>
                                    <input value="{{$program_text_book_fee->text_book_start_date}}" class="form-control" type="number" name="text_book_fee_start_date[]" placeholder="{{__('Admin/backend.start_date')}}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label>{{__('Admin/backend.end_date')}}:</label>
                                    <input value="{{$program_text_book_fee->text_book_end_date}}" class="form-control" type="number" name="text_book_fee_end_date[]" placeholder="{{__('Admin/backend.end_date')}}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label>{{__('Admin/backend.fee_type')}}:</label>
                                    <select class="form-control" name="text_book_fee_type[]">
                                        <option {{$program_text_book_fee->text_book_fee_type == 'fixed_cost' ? 'selected' : ''}} value="fixed_cost">{{__('Admin/backend.fixed_cost')}}</option>
                                        <option {{$program_text_book_fee->text_book_fee_type == 'per_week' ? 'selected' : ''}} value="cost_per_week">{{__('Admin/backend.per_week')}}</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="english">
                                        <textarea class="form-control ckeditor-input" name="text_book_note[]" placeholder="{{__('Admin/backend.note')}}" id="text_book_note{{ $loop->iteration - 1 }}">{!! $program_text_book_fee->text_book_note !!}</textarea>
                                    </div>
                                    <div class="arabic">
                                        <textarea class="form-control ckeditor-input" name="text_book_note_ar[]" placeholder="{{__('Admin/backend.note')}}" id="text_book_note_ar{{ $loop->iteration - 1 }}">{!! $program_text_book_fee->text_book_note_ar !!}</textarea>
                                    </div>
                                </div>
                            </div>
