...
class CreateTransactionTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('transaction', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('order_id')->comment('Should be the foreign key for items');
            ...
            $table->tinyInteger('status')->default(0)->comment('The transaction status is updated or not');
            $table->timestamps();
        });
    }
