...
class ChooseAccommodationUnderAgesArTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('choose_accommodation_under_ages_ar')->delete();
        
        \DB::table('choose_accommodation_under_ages_ar')->insert(array (
            0 => 
            array (
                'id' => '1',
                'unique_id' => '1616590416',
                'age' => '28',
                'created_at' => '2021-03-24 08:53:36',
                'updated_at' => '2021-03-24 08:53:36',
            ),
            1 => 
            array (
                'id' => '2',
