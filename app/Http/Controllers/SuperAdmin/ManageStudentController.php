...
class ManageStudentController extends Controller
{
    ...
    public function updateBookedUserCourse(Request $request)
    {
        ...
        $usercoursebook->room_type = Accommodation::where('unique_id', $request->room_type)->first()['room_type'] ?? null;
        $usercoursebook->meal_type = Accommodation::where('unique_id', $request->room_type)->first()['meal_type'] ?? null;
