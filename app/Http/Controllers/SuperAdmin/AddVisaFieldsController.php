...
$select = __('SuperAdmin/backend.select_option');
        $data['success'] = true;
        $data['option'] = "<select name = 'applying_from' class='form-control' id='applying_from'>
...
<option value = ''>$select</option>";
    ...
    public function addApplicationCenter(AddApplicationRequest $request)
    {
        ...
        $select = __('SuperAdmin/backend.select_option');
        $data['success'] = true;
        $data['option'] = "<select name = 'applying_from' class='form-control' id='application_center'>
<option value = ''>$select</option>";
