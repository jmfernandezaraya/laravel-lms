...
class SchoolController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('superadmin.school.add', compact('countries', 'choose_nationalities', 'school_names'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('superadmin.school.edit', compact('school', 'countries', 'choose_nationalities', 'school_names'));
    }
    ...
    public function viewCountryCityList()
    {
        ...
        return view('superadmin.school.country_city', compact('countries'));
    }
    ...
    public function viewNameList()
    {
        ...
        return view('superadmin.school.name', compact('school_names'));
    }
    ...
    public function deleteNationality(Request $request)
    {
        ...
        $data['result'] = '<option value="">' . __('SuperAdmin/backend.select') . '</option>';
