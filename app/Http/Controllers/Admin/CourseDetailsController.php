...
class CourseDetailsController extends Controller
{
    public function courseProgramDetails($course_unique_id)
    {
        ...
        return view("admin.course.course_details.program", compact('course_programs'));
    }
    ...
    public function accomodationDetails($course_unique_id)
    {
        ...
        return view("admin.course.course_details.accommodation", compact('accomodations'));
    }
    ...
    * */
    public function accomodationUderageDetails($accomadation_id)
    {
        ...
        return view('admin.course.course_details.accommodation_under_age', compact('underages'));
    }
    ...
    public function airportDetails($course_unique_id)
    {
        ...
        return view("admin.course.course_details.airport", compact('airports'));
    }
    ...
    public function courseProgramUnderAgeDetails($program_id)
    {
        ...
        return view('admin.course.course_details.program_under_age', compact('programs'));
    }
    ...
    public function medicalDetails($id)
    {
        ...
        return view('admin.course.course_details.medical_details', compact('medicals'));
    }
