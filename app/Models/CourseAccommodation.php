...
class CourseAccommodation extends Model
{
    ...
    {
        return $this->belongsTo('App\Models\Course', 'course_unique_id', 'unique_id');
    }

    public function AccommodationUnderAge()
    {
        return $this->hasOne('App\Models\CourseAccommodationUnderAge', 'accom_id', 'unique_id');
    }

    public function AccommodationUnderAges()
    {
        return $this->hasMany('App\Models\CourseAccommodationUnderAge', 'accom_id', 'unique_id')->orderBy('id', 'asc');
    }
