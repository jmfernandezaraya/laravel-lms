/**
 * Trumbowyg rich text editor control plugin
 * See https://alex-d.github.io/Trumbowyg/ for more details
 *
 * Registers Trumbowyg as a subtype for the textarea control
 */
...
window.fbControls.push(function(controlClass, allControlClasses) {
  ...
  class controlTrumbowyg extends controlTextarea {
    ...
    build() {
      ...
      // we need to manually include the icon SVG to save having to remotely include it until a fix is found for the CDN issue
      // https://github.com/cdnjs/cdnjs/issues/7609
      const icons =
    ...
    onRender(evt) {
      ...
      // configure and render the editor
      editor
        .trumbowyg({
          autogrow: true,
          resetCss: true,
